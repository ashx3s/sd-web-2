...
1. Use your assignment solution from Week 3 as a starting point for this week's assignment. Refer to the [Week 3 Assignment](/week-3/assignment) for instructions.

2. Start from scratch. To practice authentication, you really just need a simple application that has a login page and a protected page.
...
- Create a new folder called `utils` inside the app folder
- Create a file called `firebase.js` inside your `utils` folder.
...
In a `contexts` folder, create a file called `AuthContext.js` and add the following code.
...
In the `layout.js` add the following code.
...
- Submit a link to you project
- Submit a link to the deployed vercel site
- Screenshot your env file and attach the image to your submission
