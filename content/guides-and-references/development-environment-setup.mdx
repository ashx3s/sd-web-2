...
Click on "Downloads" -> choose your operating system -> "Click here to download".
...
Create an account if you do not have one. Choose a username that will work well for your professional portfolio. Avoid using a username that contains the word "SAIT". My GitHub username is `ashx3s` and you can view my public repositories here: [https://github.com/ashx3s/](https://github.com/ashx3s/).
...
Search for and then install each of the following extensions:
  ...
  - I recommend enabling "format on save" enabled by following these steps:
    ...
    3. Set the indentation to 2 spaces **4 is great for python and standard in many languages, it's standard to use 2 spaces with js**
...
- Code Spell Checker
- Find a theme that you like (I switch between monokai pro and Night Owl depending on the lighting and my mood)
- eslint
