...
User Experience (UX) in web applications goes beyond mere aesthetics. It encompasses how the application feels, how easy it is for the user to accomplish their tasks, how well the application serves the user's needs, and how performant the application is.

UX is influenced by elements of interaction design, information architecture, user research, and other disciplines. A well-designed UX can greatly enhance the effectiveness and satisfaction of web applications. This includes minimizing loading times, optimizing interactions for various devices and screen sizes, and ensuring a smooth, intuitive flow for completing tasks.

#### Useful UX Concepts and Practices

- [Mental Models](https://youtu.be/9gM8K4ooavY?si=qtRsfhj9uoO3zkw9): an internal representation of how things work. Formed from believes, ideas, and experiences. Your users don't just interact with your software, they do so with the lens of their subjective mental models.
- [User Flow Diagrams](https://www.figma.com/resource-library/user-flow/): A visual roadmap of a user's journey. These are build around user actions, goals, and decisions.
- [User Stories](https://www.interaction-design.org/literature/topics/user-stories?srsltid=AfmBOorB30IEFaVADgeXmDAKCyzAoSRQlHzAl4AxO1AWeYm5KW2SjgN3): Short statements about a feature written from a user's perspectiver.
