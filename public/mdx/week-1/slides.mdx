...
- Requested or Extra Demos

Online Lecture (2 hours)

- Lecture on Concepts and Code Patterns
- Code demonstrations
...
- Submissions after the posted deadline
  ...
  - **extensions are given when requests are accompanied with demonstration of work done so far on the assignment**: this can be as simple as some notes planning out the code or a set of links that shows you've searched the topics etc.
- You can resubmit assignments at any point
...
## Web Dev 1: Websites (static, foundational)

## Web Dev 2: Web Applications (dynamic, modern)
...
- [Diagram in Figjam](https://www.figma.com/board/t7XSJOGG4MuTkxLY0cD9jo/Web-Application-Architecture?node-id=0-1&t=BWerI3on1op00iZ5-1)
- Front-end
  - User interface
  - Client-side logic
- Back-end
