...
Create the folder `/app/week-4` and the files `page.js`, `item-list.js`, and `item.js` inside it. If you completed the Week 3 Assignment, you can copy the files from that assignment into this folder.

### `items.json`

Create a file called `items.json` in the `/app/week-4` folder. This file contains the data for the shopping list. It is an array of objects, where each object represents an item in the list.
