...
- High level overview of assignment 1 feedback
- Debrief from the lab warmup activity
- Demo: Counter component
- JavaScript: Function expressions, Arrays, Higher order functions, Arrow functions
- React: Event handlers, useState Hook **continue in in person lab**
- Tailwind CSS: States **Do next in person lab**
