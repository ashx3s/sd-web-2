...
Delete the `shopping-list/grocery-items.json` file since we will no longer be using hard-coded data.

Remove the import statement for the `grocery-items.json` file from `shopping-list/page.js`.
...
- submit the link to your github repo and the deployed site to brightspace
