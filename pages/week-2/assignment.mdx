...
In the `week-2` folder, create a file called `StudentInfo.js`.

In the `StudentInfo.js` file, code a React component called `StudentInfo` that renders (displays) the following information:
...
- Submit a link to your github repository and vercel deployment
...
- Deployment + Github Repo 1/2
- Week 2 Page + StudentInfo Component 1/4
- Main Page Setup 1/4
