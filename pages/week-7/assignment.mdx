...
Complete [Week 5 Assignment](/week-5/assignment) and [Week 6 Assignment](/week-6/assignment).
...
- Copy `GroceryItemList.js`, `GroceryItem.js`, `grocery-items.json`, and `page.js` from /week-6 to /week-7.
- Copy `NewGroceryItem.js` from /week-5 to /week-7.
...
https://cprg306-assignments.vercel.app/week-7

## Assignment Submission

- Submit a link to your repo/week-7 code to brightspace
- Submit a link to a deployed vercel site that has the week 7 code that's like the above example
