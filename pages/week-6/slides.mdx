...
- Tailwind Demo: Apply better design practices + componentization
- React: conditional rendering, controlled components
- Review HTML form elements (probably during in person)
- JavaScript: event object, preventDefault (probably during in person)
- Demo: Create a form component (probably during in person)

---

## Improving your Design Techniques

Apply these principles and methods

- [Visual Hierarchy](https://youtu.be/qZWDJqY27bw?si=IgBDbSUQZsPpskRG)
- [Repetition](https://youtu.be/8zhhc5pzE9Y?si=7FBX-may3I0YQMK7)
- [Grid Systems and Alignment](https://youtu.be/9QRIjnMEXw8?si=H4SrAps2FP3ez3P8)
- [Empty Space](https://youtu.be/3dESVj7-XzI?si=iJOOU9sN-NNGdCRK)
- [Typography](https://youtu.be/yom0nogFN3k?si=RVehELkuV6Ue4iIQ)

---

## Tailwind Specific Workflow Tips

- Progressive Enhancement with [breakpoints](https://tailwindcss.com/docs/responsive-design)
- Use flex and grid systems to manage layouts
- Do I need more empty space? the answer is probably yes
- Typography: less is more

---

## Demo: Optimize A2 Visually

- Standardize PageHeader component
- Optimize the StudentInfo Card
  - responsive design
  - visual hierarchy
  - typography
